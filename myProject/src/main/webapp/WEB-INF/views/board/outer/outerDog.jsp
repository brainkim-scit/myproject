...
<script>
	...
	jQuery(document).ready(function($){
		...
		$("#datePicker").datepicker({
			...
			onSelect: function(dateText,inst){
				...
				var sidocode;
				var sigungucode;
				DogData(pagenum,date,sidocode,sigungucode);
			}
		});
	...
	function paging(totalRecordCount, currentPage){
		...
		$.ajax({
			...
			success : function(navi){
				console.log(navi);
				var pageno = '<a href="javascript:DogData('+((navi.currentPage-5) < 1 ? 1 : (navi.currentPage-5))+')" class="icon brands style2">'+'◁'+'</a>';
					pageno += '<a href="javascript:DogData('+((navi.currentPage-1) < 1 ? 1 : (navi.currentPage-1))+')" class="icon brands style2">'+'◀'+'</a>';
				for(var page = navi.startPageGroup; page<=navi.endPageGroup; page++){
					if(page == navi.currentPage){
						...
						pageno += '<a href="javascript:DogData('+page+')" class="icon brands style2">'+page+'</a>';
					}

				};
				pageno += '<a href="javascript:DogData('+((navi.currentPage+1) >= navi.totalPageCount ? navi.endPageGroup : navi.currentPage+1)+')" class="icon brands style2">'+'▶'+'</a>';
				pageno += '<a href="javascript:DogData('+((navi.currentPage+5) >= navi.totalPageCount ? navi.endPageGroup : navi.currentPage+5)+')" class="icon brands style2">'+'▷'+'</a>';
	...
	function DogData(pagenum,date,sidocode,sigungucode){
		...
		$.ajax({
			...
			success : function(result){
				...
				}else if(!Array.isArray(DogArr) && DogArr != null){
					output = '<section class="tiles">';
					output += '<article class="style1">';
					output += '<span class="image">';
					output += '<img src="'+DogArr.popfile+'"/>';
					output += '</span>';
	...
	function detail(item,currentPage){
		...
		location += "fromWhere="+encodeURIComponent("outerDog");
